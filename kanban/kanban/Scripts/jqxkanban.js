        ...
        _populateKanban: function (g) {
            ...
            var d = function (k) {
                ...
                for (var n = 0; n < e; n++) {
                    ...
                    var s = "<img class='jqx-kanban-item-avatar-image' onclick='func()' alt= '" + o.name + "' title= '" + o.name + "' src= '" + o.image + "' />";
                    //s._addEventHandlers(window.alert("shashank"));
                    function func() {
                        window.alert("S");
                    }
